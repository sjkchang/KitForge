...
export default async function ApiExamplePage() {
    ...
    const { data: meData, error: meError } = await api.GET('/api/v1/me', {
    ...
    const { data: usersData, error: usersError } = await api.GET(
        '/api/v1/users',
        {
            headers: { Authorization: `Bearer ${token}` },
        },
            ...
            <div className="space-y-8">
                ...
                <section className="border rounded-lg p-6">
                    ...
                    <p className="mt-4 text-sm text-gray-600">
                        ✅ Fully type-safe: TypeScript knows the exact shape of
                        the response
                    </p>
                </section>
                ...
                <section className="border rounded-lg p-6">
                    <h2 className="text-2xl font-semibold mb-4">
                        All Users (GET /api/v1/users) - Admin Only
                    </h2>
                    {usersError ? (
                    ...
                    <p className="mt-4 text-sm text-gray-600">
                        ✅ Type-safe error handling: TypeScript knows possible
                        error responses
                    </p>
                </section>
                ...
                <section className="border rounded-lg p-6">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-sm">
                        <li>
                            <strong>Autocomplete:</strong> Your IDE knows all
                            available endpoints
                        </li>
                        <li>
                            <strong>Type Checking:</strong> Response types are
                            automatically inferred
                        </li>
                        <li>
                            <strong>Error Safety:</strong> Errors are typed
                            based on OpenAPI spec
                        </li>
                        <li>
                            <strong>No Manual Typing:</strong> Types are
                            generated from your API schema
                        </li>
                        <li>
                            <strong>Always in Sync:</strong> Run{' '}
                            <code>pnpm generate:client</code> to update
                        </li>
                    </ul>
                </section>

            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Quick links to help you begin
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <p className="text-sm text-muted-foreground">
                            Your SaaS starter kit is ready! You can now build
                            your application with authentication already set up.
                        </p>
                    </CardContent>
                </Card>
                ...
                {(session.user as User).role === 'admin' && (
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground">
                                As an admin, you have access to the Users page

...
export const UserSchema = z.object({
  ...
  image: z.string().nullable().describe('URL to the user\'s profile image (null if not set)'),
  ...
  updatedAt: z.string().datetime().describe('ISO 8601 timestamp of when the user was last updated'),
});
